...
장바구니가 없을 때 상품을 담기
    ...
    2. Cart 엔터티의 회원 아이디가 로그인한 사람인지
    3. Cart 엔터티의 카트 아이디와 CartProduct 엔터티의 카트 아이디가 동일해야합니다
    4. CartProduct 엔터티의 상품 아이디와 Product 엔터티의 카트 아이디가 동일해야합니다
...
public class CartController {
    ...
    public ResponseEntity<String> addToCart(@RequestBody CartProductDto dto){
        ...
        if(cart == null){
            ...
            cart = cartService.saveCart(newCart); // 데디터 베이스에 저장
        }
